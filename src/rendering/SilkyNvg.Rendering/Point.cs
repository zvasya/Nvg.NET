    ...
    internal struct Point
    {
        ...
        public void RoundJoin(float lw, float rw, float lu, float ru, uint ncap, Point other, ICollection<Vertex> verts)
        {
            ...
            if (Flags.HasFlag(PointFlags.Left))
            {
                ...
                verts.Add(new Vertex(l0, lu, 1.0f));
                verts.Add(new Vertex(Position - dl0 * rw, ru, 1.0f));
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    verts.Add(new Vertex(Position, 0.5f, 1.0f));
                    verts.Add(new Vertex(rx, ry, ru, 1.0f));
                }

                verts.Add(new Vertex(l1, lu, 1.0f));
                verts.Add(new Vertex(Position - (dl1 * rw), ru, 1.0f));
            }
            else
            {
                ...
                verts.Add(new Vertex(Position + dl0 * rw, lu, 1.0f));
                verts.Add(new Vertex(r0, ru, 1.0f));
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    verts.Add(new Vertex(lx, ly, lu, 1.0f));
                    verts.Add(new Vertex(Position, 0.5f, 1.0f));
                }

                verts.Add(new Vertex(Position + dl1 * rw, lu, 1.0f));
                verts.Add(new Vertex(r1, ru, 1.0f));
            }
        }
        ...
        private void BevelJoinRight(float lw, float rw, float lu, float ru, Point other, Vector2 dl0, Vector2 dl1, ICollection<Vertex> verts)
        {
            ...
            verts.Add(new Vertex(Position + dl0 * lw, lu, 1.0f));
            verts.Add(new Vertex(r0, ru, 1.0f));
            ...
            if (Flags.HasFlag(PointFlags.Bevel))
            {
                ...
                verts.Add(new Vertex(Position + dl1 * lw, lu, 1.0f));
                verts.Add(new Vertex(r1, ru, 1.0f));
            }
            else
            {
        ...
        public void Join(ref  Point other, float iw, bool bevelOrRound, float miterLimit, ref uint nleft, ref uint bevelCount)
        {
            ...
            MatrixDeterminant = new Vector2((dl0.X + dl1.X) * 0.5f, (dl0.Y + dl1.Y) * 0.5f);
        ...
        public static void Vertex(in Point p0, in Point p1, float woff, ICollection<Vertex> verts)
        {
            if ((p1.Flags & PointFlags.Bevel) != 0)
            {
                ...
                if ((p1.Flags & PointFlags.Left) != 0)
                {
                    ...
                    verts.Add(new Vertex(l, 0.5f, 1.0f));
                }
                else
                {
            ...
            {
                verts.Add(new Vertex(p1.Position + (p1.MatrixDeterminant * woff), 0.5f, 1.0f));
            }
        }
        ...
        private static void ChooseBevel(bool bevel, Point p0, Point p1, float w, out Vector2 pos0, out Vector2 pos1)
        {
            if (bevel)
            {
                pos0 = new Vector2(p1.Position.X + p0.Determinant.Y * w, p1.Position.Y - p0.Determinant.X * w);
                pos1 = new Vector2(p1.Position.X + p1.Determinant.Y * w, p1.Position.Y - p1.Determinant.X * w);
            }
            else
            {
                pos0 = new Vector2(p1.Position.X + p1.MatrixDeterminant.X * w, p1.Position.Y + p1.MatrixDeterminant.Y * w);
                pos1 = new Vector2(p1.Position.X + p1.MatrixDeterminant.X * w, p1.Position.Y + p1.MatrixDeterminant.Y * w);
            }
        }
