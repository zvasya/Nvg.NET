    ...
    public static class NvgScissoring
    {
        ...
        public static void Scissor(this Nvg nvg, RectangleF rect)
        {
            ...
            nvg.stateStack.CurrentState.Scissor = new Scissor(
                NvgTransforms.Multiply(transform, nvg.stateStack.CurrentState.Transform),
        ...
        public static void IntersectScissor(this Nvg nvg, RectangleF rect)
        {
            ...
            _ = NvgTransforms.Inverse(out Matrix3x2 invtransform, nvg.stateStack.CurrentState.Transform);
            ptransform = NvgTransforms.Multiply(ptransform, invtransform);
